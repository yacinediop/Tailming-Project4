  ...
  return (
   <section id='home' className={'flex md:flex-row flex-col §{styles.paddingY}'}>
       <div className={'flex-1 §{styles.flexStart flex-col xl:px-0 sm:px-16 px-6}'}>
         ...
         <div className='flex flex-row items-center p-[6px] px-bg-discount-gradient rounded-[10px] mb-2'>
         ...
         <h1 className='font-poppins font-semiboldn ss:text-[68px] text-[52px] text-white
               ss:leading-[100px] leading-[75px] w-full'>
                   Payment Method.
               </h1>
               <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
                Our team of experts uses a methodology to identify the credit cards most likely to fit your needs.
                We examine annual percentage rates, annual fess.</p>
       </div>
