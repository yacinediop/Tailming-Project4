         ...
         flex-col sm:mb-16 mb-6 relative z-[1]'>
          ...
          <div className='w-full md:mt-0  mt-6'>
             <p className={`${styles.paragraph} text-left max-w-[450px]`}>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Amet quisquam vero ipsam veniam tenetur magni, ipsum consectetur tempore saepe, recusandae dolor fugit assumenda. Voluptatem eum numquam ex nesciunt blanditiis adipisci.
